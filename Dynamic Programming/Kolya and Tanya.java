...
public class Main {
    ...
    static void testcase() {
        ...
        // we could also do it using dp, we need to keep if we got at some point a sum!=6 , then at the base case we return 1 else we return 0 and count like this ; 
        for (int i = 0; i <= n; i++)
            dp[i][0] = dp[i][1] = -1;
        out.println(S(0, 0));
